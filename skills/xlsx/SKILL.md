...
**Note**: Formulas are stored as strings. When the user opens the file in Excel/LibreOffice, the application will recalculate all formula values automatically.
